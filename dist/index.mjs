...
var BybitWallet = class {
  constructor() {
    ...
    this.readyState = typeof window !== "undefined" ? (window == null ? void 0 : window.bybitWallet) ? WalletReadyState.Installed : WalletReadyState.NotDetected : WalletReadyState.Unsupported;
  }
