...
declare const BybitWalletName: WalletName<"Bybit Wallet">;
declare class BybitWallet implements AdapterPlugin {
    readonly name: WalletName<"Bybit Wallet">;
...
export { BybitWallet, BybitWalletName };
